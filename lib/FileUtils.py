...
#    def test_zipDir():
#        zipfile = "myfile.zip"
#        print f._zipDir("/etc/X11/xkb", "/tmp/myfile.zip")
#        print f.zipDir("/etc/X11/xkb", zipfile)
#        os.system("unzip -l %s" % zipfile)
#        os.remove(zipfile)
#
#    def test_dirSize():
#        print f.getDirSize("/etc/X11/xkb")
#
#    def test_deleteDir():
#        tmp_path = "/tmp/my_xkb_copy"
#        print "copying..."
#        os.system("cp -Rp /etc/X11/xkb %s" % tmp_path)
#        os.system("ls -l %s" % tmp_path)
#        dirs = ["%s/rules" % tmp_path, "%s/keymap/sun_vndr" % tmp_path]
